  ...
  function renderStatsConta() {
    ...
    document.getElementById("stats").innerHTML = `
      <div class="card tinted financeiro">
        ...
        <div class="stat-value num" style="color:${r.saldo < 0 ? "var(--st-critical)" : "var(--texto)"};">${fmt.moeda(r.saldo)}</div>
  ...
  function renderLancamentos() {
    ...
    lista.forEach((t) => {
      ...
      tr.innerHTML = `
        ...
        <td class="right" style="color:${receita ? "var(--success-text)" : "var(--texto)"};">${receita ? "+" : "−"}${fmt.moeda(Math.abs(Number(t.valor) || 0))}</td>
